            ...
            <div class="sidebar-wrapper">
                <nav class="mt-2">
                    ...
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu"
                        ...
                        <li class="nav-item menu-open">
                            <a href="{{route('showcaseconsultant')}}" class="nav-link">
                        ...
                        <li class="nav-item menu-open">
                            <a href="{{route('sesi')}}" class="nav-link active">
        ...
        <main class="app-main">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Jadwal Sesi</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Jadwal Sesi</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Daftar Jadwal Sesi</h3>
                        </div>
                        <div class="card-body">
